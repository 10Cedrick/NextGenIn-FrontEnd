  ...
  return (
    <DashboardLayout>
        ...
        <div className="pt-8 mt-24 ">
            ...
            <div className="pt-8 mt-24 ">
                <h1 className="text-lg section-title ">Personne ayant les mêmes centres d'intérêt que vous</h1>
            ...
            <div className="pt-8 mt-24 border-t border-slate-700 mb-24">
                <h1 className="text-lg section-title mb-4">Question les plus posés par les novices</h1>
                {faqList.map((item) => (
                    <>
